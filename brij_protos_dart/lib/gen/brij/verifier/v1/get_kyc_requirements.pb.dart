...
class Requirement extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Requirement', package: const $pb.PackageName(_omitMessageNames ? '' : 'brij.verifier.v1'), createEmptyInstance: create)
    ..e<$20.DataType>(1, _omitFieldNames ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: $20.DataType.DATA_TYPE_UNSPECIFIED, valueOf: $20.DataType.valueOf, enumValues: $20.DataType.values)
  ...
  @$pb.TagNumber(1)
  $20.DataType get type => $_getN(0);
  @$pb.TagNumber(1)
  set type($20.DataType v) { $_setField(1, v); }
  @$pb.TagNumber(1)
...
class Formula_Condition extends $pb.GeneratedMessage {
  factory Formula_Condition({
    ...
    $20.DocumentFieldType? documentField,
  }) {
    final $result = create();
    if (countryCode != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Formula.Condition', package: const $pb.PackageName(_omitMessageNames ? '' : 'brij.verifier.v1'), createEmptyInstance: create)
    ...
    ..e<$20.DocumentType>(2, _omitFieldNames ? '' : 'documentType', $pb.PbFieldType.OE, defaultOrMaker: $20.DocumentType.DOCUMENT_TYPE_UNSPECIFIED, valueOf: $20.DocumentType.valueOf, enumValues: $20.DocumentType.values)
    ..e<$20.DocumentFieldType>(3, _omitFieldNames ? '' : 'documentField', $pb.PbFieldType.OE, defaultOrMaker: $20.DocumentFieldType.DOCUMENT_FIELD_TYPE_UNSPECIFIED, valueOf: $20.DocumentFieldType.valueOf, enumValues: $20.DocumentFieldType.values)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $20.DocumentType get documentType => $_getN(1);
  @$pb.TagNumber(2)
  set documentType($20.DocumentType v) { $_setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  $20.DocumentFieldType get documentField => $_getN(2);
  @$pb.TagNumber(3)
  set documentField($20.DocumentFieldType v) { $_setField(3, v); }
  @$pb.TagNumber(3)
