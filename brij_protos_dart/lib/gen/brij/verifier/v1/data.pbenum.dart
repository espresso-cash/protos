...
class DocumentFieldType extends $pb.ProtobufEnum {
  static const DocumentFieldType DOCUMENT_FIELD_TYPE_UNSPECIFIED = DocumentFieldType._(0, _omitEnumNames ? '' : 'DOCUMENT_FIELD_TYPE_UNSPECIFIED');
  static const DocumentFieldType DOCUMENT_FIELD_TYPE_ID_NUMBER = DocumentFieldType._(1, _omitEnumNames ? '' : 'DOCUMENT_FIELD_TYPE_ID_NUMBER');
  static const DocumentFieldType DOCUMENT_FIELD_TYPE_PHOTO_FRONT = DocumentFieldType._(2, _omitEnumNames ? '' : 'DOCUMENT_FIELD_TYPE_PHOTO_FRONT');
  static const DocumentFieldType DOCUMENT_FIELD_TYPE_PHOTO_BACK = DocumentFieldType._(3, _omitEnumNames ? '' : 'DOCUMENT_FIELD_TYPE_PHOTO_BACK');

  static const $core.List<DocumentFieldType> values = <DocumentFieldType> [
  ...
  static final $core.Map<$core.int, DocumentFieldType> _byValue = $pb.ProtobufEnum.initByValue(values);
  static DocumentFieldType? valueOf($core.int value) => _byValue[value];

  const DocumentFieldType._(super.v, super.n);
}
