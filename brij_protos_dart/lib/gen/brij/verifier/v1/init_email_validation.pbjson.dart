...
@$core.Deprecated('Use initEmailValidationRequestDescriptor instead')
...
const InitEmailValidationResponse$json = {
  '1': 'InitEmailValidationResponse',
};

/// Descriptor for `InitEmailValidationResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List initEmailValidationResponseDescriptor = $convert.base64Decode(
    'ChtJbml0RW1haWxWYWxpZGF0aW9uUmVzcG9uc2U=');
