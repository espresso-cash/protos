...
@$core.Deprecated('Use initPhoneValidationRequestDescriptor instead')
...
const InitPhoneValidationResponse$json = {
  '1': 'InitPhoneValidationResponse',
};

/// Descriptor for `InitPhoneValidationResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List initPhoneValidationResponseDescriptor = $convert.base64Decode(
    'ChtJbml0UGhvbmVWYWxpZGF0aW9uUmVzcG9uc2U=');
